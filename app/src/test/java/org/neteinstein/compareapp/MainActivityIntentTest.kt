...
class MainActivityIntentTest {
    ...
    fun testOpenInSplitScreen_launchesUberIntent() {
        ...
        // When - Trigger the openInSplitScreen via reflection since it's private
    ...
    fun testOpenInSplitScreen_correctIntentSequence() {
        ...
        // Give coroutines time to execute all intents
        Thread.sleep(100)
    ...
    fun testOpenInSplitScreen_handlesUberError() {
        ...
        try {
            method.invoke(activity, invalidUberDeepLink, boltDeepLink, boltDeepLinkWeb)
            Thread.sleep(100)
    ...
    fun testOpenInSplitScreen_handlesBoltError() {
        ...
        try {
            method.invoke(activity, uberDeepLink, invalidBoltDeepLink, boltDeepLinkWeb)
            Thread.sleep(100)
    ...
    fun testOpenInSplitScreen_allIntentsHaveCorrectFlags() {
        ...
        val allIntents = listOf(intent1, intent2, intent3)
